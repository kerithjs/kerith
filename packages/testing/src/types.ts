...
export interface FixtureOpts {
  ...
  /**
   * Optional route prefix for the health check endpoint.
   * If set to '/api/v1', the health check will poll /api/v1/health instead of /health.
   */
  routePrefix?: string;
}

// ---------------------------------------------------------------------------
// Scaffold options (runCreateKerith)
// ---------------------------------------------------------------------------

export interface ScaffoldOptions {
  /** Descriptive name used as test label and temp-dir suffix. */
  name: string;
  template: 'core' | 'app';
  language: 'ts' | 'js';
  channels?: string[];
  ...
  port?: number;
  routePrefix?: string;
  /** Map of package name to local tarball path, generated by pack-workspace-tarballs */
