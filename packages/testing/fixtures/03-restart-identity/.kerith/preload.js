...
const KERITH_PRELOAD_CONFIG = {
  ...
  aliases: {
    ...
    '@commerce': resolve(__dirname, '../src/modules/commerce'),
    '@modules/health': resolve(__dirname, '../src/modules/health'),
    '@modules/catalog': resolve(__dirname, '../src/modules/commerce/catalog'),
    '@modules/store': resolve(__dirname, '../src/modules/commerce/store'),
  },
  preloaded: true,
