...
/**
 * Loads the NITS registry from the standardized path (.Kerith/registry.json).
...
/**
 * Saves the NITS registry to the standardized path (.Kerith/registry.json).
 ...
 *
 * Called AFTER reconcile() completes. Creates `.Kerith` shadow files for
